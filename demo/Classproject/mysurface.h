#ifndef GM_PARAMETRICS_SURFACES_MYSurface_H
#define GM_PARAMETRICS_SURFACES_MYSurface_H
...
template <typename T>
  ...
  // Constructors and destructor
    MYSurface( GMlib::PSurf<T,3>* s, T su, T eu, T sv, T ev);
    MYSurface( GMlib::PSurf<T,3>* s, T su, T eu, T u, T sv, T ev, T v);
    MYSurface( const MYSurface<T>& copy );
    virtual ~MYSurface() {}
  protected:
  ...
  //***********************************************************
  // Include MYSurface class function implementations ****
  ...
  //*****************************************
    template <typename T>
    inline
    MYSurface<T>::MYSurface( GMlib::PSurf<T,3>* s, T su, T eu, T sv, T ev)
    {
    ...
    template <typename T>
    inline
    MYSurface<T>::MYSurface( GMlib::PSurf<T,3>* s, T su, T eu, T u, T sv, T ev, T v )
    {
    ...
    template <typename T>
    inline
    MYSurface<T>::MYSurface( const MYSurface<T>& copy ) : GMlib::PSurf<T,3>( copy )
    {
    ...
    //*****************************************************
    template <typename T>
    void MYSurface<T>::eval( T u, T v, int d1, int d2, bool /*lu*/, bool /*lv*/) const {
      this->_p.setDim(3,3);
    ...
    template <typename T>
    inline
    void MYSurface<T>::set(GMlib::PSurf<T,3>* s, T su, T eu, T u, T sv, T ev, T v) {
      _s  = s;
      _su = su;
      _sv = sv;
      _eu = eu;
...
#endif // GM_PARAMETRICS_SURFACES_MYSurface_H
